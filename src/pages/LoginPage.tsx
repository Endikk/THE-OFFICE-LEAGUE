      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-office-brown/60 mt-2">
            Paris sportifs entre collegues
          </p>
        </div>

        {/* Card */}
        <div className="card p-8">
          <h2 className="text-xl font-bold text-office-navy mb-6">Connexion</h2>

          {error && <div className="error-box mb-4">{error}</div>}

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-office-navy mb-1.5">
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-office-navy mb-1.5">
                Mot de passe
              </label>
              <input
                id="password"
          ...
          <p className="text-center text-sm text-office-brown/50 mt-6">
            ...
            <Link to="/register" className="text-office-navy font-semibold hover:text-office-mustard transition-colors">
              S'inscrire
            </Link>
          </p>
        </div>
